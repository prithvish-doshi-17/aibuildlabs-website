    ...
    <main>
      ...
      <section className="hero section-shell" id="top">
        ...
        <div className="hero-footnote">
          <span>EST. 2026</span>
          <span className="scroll-cue">Scroll to enter the lab <i>↓</i></span>
            ...
            <div className="code-window">
              ...
              <div className="code-body">
                ...
                <div className="code-lines">
                  ...
                  <p className="code-blue">→ verification plan ready</p>
                </div>
              </div>
      ...
      <section className="contact section-shell">
        <div className="contact-card">
          ...
          <a className="button button-light" href="mailto:hello@aibuildlabs.dev">
            hello@aibuildlabs.dev <span aria-hidden="true">↗</span>
          </a>
        </div>
      </section>
